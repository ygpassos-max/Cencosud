...
URL_PLANILHA_LEITURA = (
    "https://docs.google.com/spreadsheets/d/1RzJ41JQQPM6ibJrnxmaJNq5JCZiROXAemsaxBvcQV2I/edit?usp=sharing"
)
...
# ---------------------------------------------------------
# LEITURA E GRAVAÇÃO VIA GOOGLE SHEETS / WEBHOOK
# ---------------------------------------------------------
@st.cache_data(ttl=10)
def carregar_cotacoes_google():
    """Lê as cotações públicas exportadas em CSV do Google Sheets."""
    try:
